...
export const auctionApi = {
  list(params: {
    ...
    return get('/api/auction', params) as any
  },
  ...
  review(payload: { auction_id: number; reviewer_session_id: string; stars: number; comment?: string }): Promise<ApiResponse<unknown>> {
